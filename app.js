...
function getDestinationBot(context) {
     ...
     */
    if (context && context.destination_bot && context.destination_bot.toUpperCase() === "ResiliencySkills") {
        return process.env['02d797e3-f75b-4403-a229-18346e4869de'];
    } else if (context && context.destination_bot && context.destination_bot.toUpperCase() === "BluepagesSkills") {
        return process.env['ca39e110-7537-4f19-841c-bb700c780817'];
    } else {
        return process.env["WORKSPACE_ID_agentBot"];
    }
